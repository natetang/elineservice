...
# Elineservice Synchronizer. This loads the config file and starts the synchronizer
...
config_file = os.path.abspath(os.path.dirname(os.path.realpath(__file__)) + '/elineservice_config.yaml')
